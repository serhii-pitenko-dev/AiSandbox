...
//        Assert.AreEqual(EObjectType.Hero, result.Cells[0, heroScreenY].CellType);

//        // Verify Enemy positions
//        // Enemy 1: Cartesian X3Y4 -> Screen X3Y10
//        int enemy1ScreenY = 15 - 1 - 4; // = 10
//        Assert.AreEqual(EObjectType.Enemy, result.Cells[3, enemy1ScreenY].CellType);

//        // Enemy 2: Cartesian X8Y8 -> Screen X8Y6
//        int enemy2ScreenY = 15 - 1 - 8; // = 6
//        Assert.AreEqual(EObjectType.Enemy, result.Cells[8, enemy2ScreenY].CellType);

//        // Verify Block positions (Cartesian to Screen conversion)
//        // Block 1: Cartesian X1Y1 -> Screen X1Y13
//        Assert.AreEqual(EObjectType.Block, result.Cells[1, 13].CellType);
//        // Block 2: Cartesian X5Y5 -> Screen X5Y9
//        Assert.AreEqual(EObjectType.Block, result.Cells[5, 9].CellType);
//        // Block 3: Cartesian X9Y9 -> Screen X9Y5
//        Assert.AreEqual(EObjectType.Block, result.Cells[9, 5].CellType);
